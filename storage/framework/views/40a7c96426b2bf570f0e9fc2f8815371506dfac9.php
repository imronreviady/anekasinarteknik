		...
		<div class="single-product-detail">
			<div class="row">
				<div class="col-12 col-lg-5">
					<div class="demo">
						<ul id="lightSliderGallery" class="lightSlider" data-gallery="true" data-item="1" data-loop="true" data-auto="true" data-thumbs="4" data-controls="false" data-position="middle">
							<li data-thumb="assets/img/demo/ss1.png">
								<img src="assets/img/demo/ss1.png">
							</li>
				...
				<div class="col-12 col-lg-6 mx-md-auto">
					<div class="single-product-overview p-t-b-40">
						<?php $i = 0; $j = 0;?>
						<h2><?php echo e($result['product'][$i]->products_name); ?></h2>
						<ul class="review p-t-b-20">
							<li class="ratings-stars"><i class="icon icon-star text-light-blue"></i><i class="icon icon-star text-light-blue"></i><i class="icon icon-star text-light-blue"></i> <i class="icon icon-star text-light-blue"></i><i class="icon icon-star"></i>
						...
						<div class="cart-options">
							<span href="#" class="price"><span>$2500</span>  <del>$7000</del></span>
				...
				<div class="col-12 col-lg-12 ">
					<div class="product-tabs">
						<ul class="nav nav-tabs">
							<li class="active nav-item"><a href="#one-2" data-toggle="tab" class="nav-link">Description</a></li>
							<li class="nav-item"><a href="#two-2" data-toggle="tab" class="nav-link">Specification</a></li>
							<li class="nav-item"><a href="#three-2" data-toggle="tab" class="nav-link">Return Info</a></li>
						</ul>

						<!-- Tab panes -->
						<div class="tab-content">
							<div class="tab-pane fade in active" id="one-2">
								<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, nec sagittis sem lorem quis bibe dum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a nec sagittis sem sit amet mauris. Morbi accumsan ipsum velit. Nam ne tellus a odio tincidunt auctor a ornare odio. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, nec sagittis sem lorem quis bibe dum auctor.</p>
				...
				<div class="lightSlider grid-view xv-product-slides" data-item="4" data-item-md="2" data-item-sm="1">
					<div class="xv-product-unit col-3">
						<div class="xv-product paper-block">
							<figure>
								<a href="#"><img class="xv-superimage" src="assets/img/demo/s1.png" alt=""></a>
								<figcaption>
									<ul class="style1">
							...
							<div class="xv-product-content">
								...
								<p>Aenean sollicitudin, nec sagittis sem lorem quist bibe dum auctor, nisi
								elit consequat ipsum. Duis sed odio sit amet nibh vulputate cursus a nec.</p>
								<ul class="color-opt">
								...
								<a data-qv-tab="#qvt-cart" href="#" class="product-buy flytoQuickView"><i class="icon icon-shopping-basket" aria-hidden="true"></i></a>
							</div>
							<!--xv-product-content-->
						</div>
					...
					<div class="xv-product-unit col-3">
						<div class="xv-product paper-block">
							<figure>
								<a href="#"><img class="xv-superimage" src="assets/img/demo/s2.png" alt=""></a>
								<figcaption>
									<ul class="style1">
										<li><a data-qv-tab="#qvt-wishlist" class=" btn-square btn-blue" href="#"><i class="icon icon-heart"></i></a></li>
					...
					<div class="xv-product-unit col-3">
						<div class="xv-product paper-block">
							<figure>
								<a href="#"><img class="xv-superimage" src="assets/img/demo/s3.png" alt=""></a>
								<figcaption>
									<ul class="style1">
										<li><a data-qv-tab="#qvt-wishlist" class=" btn-square btn-blue" href="#"><i class="icon icon-heart"></i></a></li>
										<li><a data-qv-tab="#qvt-compare" class=" btn-square btn-blue" href="#"><i class="icon icon-exchange"></i></a></li>
					...
					<div class="xv-product-unit col-3">
						<div class="xv-product mb-15 mt-15 paper-block">
							<figure>
								<a href="#"><img class="xv-superimage" src="assets/img/demo/s4.png" alt=""></a>
								<figcaption>
									<ul class="style1">
										<li><a data-qv-tab="#qvt-wishlist" class=" btn-square btn-blue" href="#"><i class="icon icon-heart"></i></a></li>
										<li><a data-qv-tab="#qvt-compare" class=" btn-square btn-blue" href="#"><i class="icon icon-exchange"></i></a></li>
					...
					<div class="xv-product-unit col-3">
						<div class="xv-product mb-15 mt-15 paper-block">
							<figure>
								<a href="#"><img class="xv-superimage" src="assets/img/demo/s5.png" alt=""></a>
								<figcaption>
									<ul class="style1">
										<li><a data-qv-tab="#qvt-wishlist" class=" btn-square btn-blue" href="#"><i class="icon icon-heart"></i></a></li>
										<li><a data-qv-tab="#qvt-compare" class=" btn-square btn-blue" href="#"><i class="icon icon-exchange"></i></a></li>
					...
					<div class="xv-product-unit col-3">
						<div class="xv-product mb-15 mt-15 paper-block">
							<figure>
								<a href="#"><img class="xv-superimage" src="assets/img/demo/s6.png" alt=""></a>
								<figcaption>
									<ul class="style1">
										<li><a data-qv-tab="#qvt-wishlist" class=" btn-square btn-blue" href="#"><i class="icon icon-heart"></i></a></li>
										<li><a data-qv-tab="#qvt-compare" class=" btn-square btn-blue" href="#"><i class="icon icon-exchange"></i></a></li>
